                    ...
                    {memberBtns.map((item, index) => (
                        <div
                            ...
                            className={
                                styles['item-member'] +
                                ' ' +
                                (memberSelectIndex === index ? styles['item-member-active'] : '')
                            }
                ...
                <div className={styles['warp-menu']}>
                    {departmentList.map((item, index) => (
                        <div
                            ...
                            onClick={() => memberSelectClick(index + memberBtns.length, item.id)}
                        >
                            <PartitionOutlined className={classnames(styles['item-member-icon'])} />
